public class Point {
    ...
    // Standard constructor, this is a concept of functional overloading: more than one methods of the same name are declared with differing parameters. (Python does not support)
